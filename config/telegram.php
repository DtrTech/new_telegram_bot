...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_1')
        ],
        'mybot2' => [
            'token' => env('TELEGRAM_2')
        ],
        'mybot3' => [
            'token' => env('TELEGRAM_3')
        ],
        'mybot4' => [
            'token' => env('TELEGRAM_4')
        ],
        'mybot5' => [
            'token' => env('TELEGRAM_5')
        ],
    ],
    ...
    */
    ...
    | 3. Group using shared commands: Provide the key name of the shared command
    ...
    | 4roups of commands to bundle them into one group.
    | 4. You can create a group with a combination of 1, 2 and 3 all together in one group.
    |
    | 5xamples shown below are by the group type for you to understand each of them.
    */
    'command_groups' => [
        /* // Group Type: 1
           'commmon' => [
